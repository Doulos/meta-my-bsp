...
DELTA_KERNEL_DEFCONFIG = "myboard/cfg/wireguard.cfg"

#### Begin linux-yocto setup

#AT: ALTERNATIVELY - to make this kernel use linux-yocto style 
#fragments and kernel features, uncomment the following (to the end of file):
#inherit kernel
